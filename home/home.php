...
<body>
    ...
    <header class="header">
        <img src="admin/image/logo.jpg" alt="Education Bureau Logo" class="logo">
    ...
    <section class="main-section">
        <img src="" alt="">
        <h2>Welcome to the Maya City Education Bureau</h2>
    ...
    <section class="stats">
        ...
        ?>
        <div class="stat">
            <h2>📚 <?php echo number_format($students); ?>+</h2>
            <p>Students</p>
        </div>
        <div class="stat">
            <h2>👩‍🏫 <?php echo number_format($teachers); ?>+</h2>
            <p>Teachers</p>
        </div>
        <div class="stat">
            <h2>🏫 <?php echo number_format($schools); ?>+</h2>
            <p>Schools</p>
        </div>
    </section>
     <!-- Services Section -->
     <section class="services">
        ...
        <div class="service-box">
            ...
            <p>We provide high-quality education services.</p>
        </div>
        <div class="service-box">
            <h3>🎓 Teacher Training</h3>
            <p>We train teachers to improve education.</p>
        </div>
        <div class="service-box">
            <h3>📜 Certifications</h3>
            <p>We issue academic certifications.</p>
        </div>
    </section>
    ...
    <section class="news">
        <h2>Latest News</h2>
        <p>New school policies have been introduced...</p>
    </section>
    </section>
    ...
    <footer class="footer">
        ...
        <h1><marquee direction="left" style="font-family: serif; font-size: 25px;font-weight: bold;">&copy; 2025 Maya City Education Bureau. Designed by IT Students.</h1> 
    </footer>
