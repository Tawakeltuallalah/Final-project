...
<body class="bg-gray-100 flex">
    <div class="header">
        <button class="menu-btn" id="menu-btn" onclick="toggleSidebar()">☰ Manager Dashboard</button>
    ...
    <div id="sidebar" class="bg-gray-900 text-white w-64 min-h-screen fixed top-0 left-0 transform -translate-x-full transition-transform duration-300 lg:translate-x-0">
        ...
        <nav class="mt-5">
            <a href="#" onclick="loadContent('Educational_Statistics.php')" class="sidebar">📊 Educational Statistics</a>
            <a href="#" onclick="loadContent('manage_schools.php')" class="sidebar">🏫 Manage Schools</a>
            <a href="#" onclick="loadContent('manage_complaints.php')" class="sidebar">📩 Manage Complaints</a>
            <a href="#" onclick="loadContent('resource_management.php')" class="sidebar">📂 Resource Management</a>
            <a href="#" onclick="loadContent('approve_requests.php')" class="sidebar">✅ Approve/Reject Requests</a>
           
            <a href="#" onclick="loadContent('material.php')" class="sidebar">📚 Upload Material</a>
    ...
    <div id="main-content" class="flex-1 mt-16 lg:ml-64 p-6 transition-all duration-300">
        <h2 class="text-2xl font-bold">Welcome, Manager!</h2>
        <p class="text-gray-600">Manage education bureau tasks efficiently.</p>
